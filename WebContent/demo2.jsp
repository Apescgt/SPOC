...
window.onload = function(){
 ...
 function b() {
     ...
     function reply(box) {
         ...
         var html = '<div class="comment-left">' + '<img src="lg.jpg" alt=""/>' + '</div>' +
...
<ul id="pn">
    <li class="list0"> <a class="close" href="javascript:;"></a>
        <div class="head"><img src="" alt=""></div>
        <div class="content">
            <p class="text" style="font-size:15px"><span class="name" style="font-size:15px">老师A：</span>请同学们认真完成章节测验！</p>
            <div class="pic"><img src="" alt=""></div>
            <div class="good"><span class="date">06-01 13:01</span><a class="dzan" href="javascript:;">赞</a></div>
            <div class="people" total="80">30人觉得很赞</div>
            <div class="comment-list">
                <div class="comment" user="self">
                    <div class="comment-left"><img src="" alt=""></div>
                    <div class="comment-right">
                        <div class="comment-text"><span class="user">小明：</span>好的老师</div>
                        <div class="comment-date">06-01 22:00 <a class="comment-zan" href="javascript:;" total="23" my="1">23 取消赞</a> <a class="comment-dele" href="javascript:;">回复</a> </div>
                    </div>
                </div>
                <div class="comment" user="self">
                    <div class="comment-left"><img src="" alt=""></div>
                    <div class="comment-right">
                        <div class="comment-text"><span class="user">我：</span>老师辛苦了！</div>
                        <div class="comment-date">06-01 23:12 <a class="comment-zan" href="javascript:;" total="0" my="0">赞</a> <a class="comment-dele" href="javascript:;">删除</a> </div>
                    </div>
                </div>
            </div>
            <div class="hf">
    ...
    <li class="list0"> <a class="close" href="javascript:;">X</a>
        <div class="head"><img src="" alt=""></div>
        <div class="content">
            <p class="text"><span class="name">老师A：</span>同学们有不懂的问题可以随时留言!</p>
            <div class="pic"><img src="" alt=""></div>
            <div class="good"><span class="date">06-01 23:01</span><a class="dzan" href="javascript:;">赞</a></div>
            <div class="people" total="0" style="display: none;"></div>
            <div class="comment-list">
                <div class="comment" user="self">
                    <div class="comment-left"><img src="" alt=""></div>
                    <div class="comment-right">
                        <div class="comment-text"><span class="user">我：</span>谢谢老师！</div>
                        <div class="comment-date">06-01 24:08 <a class="comment-zan" href="javascript:;" total="16" my="1">16 取消赞</a> <a class="comment-dele" href="javascript:;">删除</a> </div>
                    </div>
                </div>
            </div>
            <div class="hf">
